  ...
  if ($cek > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi')
      ...
      <head>
        ...
        <title>Aplikasi E-VOTE FIP</title>
        <!---------------------------------------------------------------------->
        ...
        <div class="adjust-nav">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
              ...
              <h4 style="color: white;">Sistem E-VOTE FIP</h4>
            </a> 
          </div>
          ...
          <div class="row">
            <div class="col-lg-12 ">
              <div class="alert alert-info">
                <strong><h2><b>Selamat datang</b></h2></strong><b style="font-size: 18px;"><?php echo $_SESSION['nama_mhs']; ?></b> Di Aplikasi E-VOTE FIP
              </div>   
            </div>
          </div>
